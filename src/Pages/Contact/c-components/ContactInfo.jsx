...
const ContactInfo = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/jonathancw-tang",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-3">
          {socialLinks.map((social, index) => (
            ...
            >
              <span className="mr-3 flex h-9 w-9 items-center justify-center rounded-lg bg-white text-navy-700 shadow-sm">
                {social.icon}
              </span>
