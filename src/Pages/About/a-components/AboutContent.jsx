...
const AboutContent = () => {
  return (
    <section className="max-w-7xl mx-auto sm:px-10 py-8">
      <div>
        <div>
          <h2 className="text-4xl font-bold mb-6">Welcome to my Portfolio!</h2>
          <p className="text-lg text-gray-700 mb-12 leading-relaxed">
            I am Jonathan Tang, a third year Civil Engineer undergraduate student, pursuing a minor in Artificial Intelligence Engineering in the University of Toronto. This portfolio highlights the skills I’ve developed so far and the direction I’m striving toward as I continue building my path in the engineering profession.
          </p>
