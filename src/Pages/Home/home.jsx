    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className={`relative max-w-7xl mx-auto transition-all duration-1000 ${
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                ...
                <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80">
                  {/* Decorative border */}
                  <div className="absolute inset-0 rounded-full bg-gradient-to-br from-slate-200 to-gray-300 animate-pulse-slow"></div>
                  {/* Image container */}
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-4 -right-4 bg-slate-700 text-white px-4 py-2 rounded-full shadow-lg flex items-center gap-2" style={{ backgroundColor: '#334e68' }}>
            ...
            <div className="text-center lg:text-left max-w-2xl">
              {/* Greeting */}
              <div className="mb-6">
                <span className="inline-block px-4 py-2 bg-slate-100 text-slate-800 rounded-full text-sm font-medium border border-slate-200">
              ...
              {/* Subtitle */}
              <div className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-700 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                <Link
                  to="/projects"
                  className="group px-8 py-4 bg-slate-700 hover:bg-slate-800 text-white font-semibold rounded-lg shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center"
                ...
                <Link
                  to="/contact"
                  className="px-8 py-4 bg-white text-gray-700 font-semibold rounded-lg border-2 border-gray-300 shadow-sm hover:border-slate-700 hover:text-slate-700 hover:shadow-md transform hover:scale-105 transition-all duration-300 flex items-center justify-center"
                >
                  Get In Touch
                </Link>
              </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/contact"
            className="inline-block px-8 py-4 bg-slate-700 hover:bg-slate-800 text-white font-semibold rounded-lg shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            style={{ backgroundColor: '#334e68' }}
          >
            Let's Talk
          </Link>
