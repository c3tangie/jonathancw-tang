    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                ...
                <div className="relative w-80 h-80 sm:w-96 sm:h-96 lg:w-[460px] lg:h-[460px]">
                  {/* Decorative border */}
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/contact"
            className="inline-block navy-button px-8 py-4 bg-slate-700 hover:bg-slate-800 text-white font-semibold rounded-lg shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            style={{ backgroundColor: '#334e68' }}
          >
            Contact Me
          </Link>
